...
This document lists the authoritative Microsoft documentation sources used to verify information in this repository.

## Primary Microsoft Resources

### Certification and Exam

- [AZ-104 Study Guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/az-104) — Official exam blueprint and objectives (as of April 17, 2026)
...
- [Azure Subscriptions](https://learn.microsoft.com/en-us/azure/cost-management-billing/manage/overview-iam)
...
- [Storage Account Security](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-keys-manage)
...
- [Subnets and Network Interfaces](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-network-interface)
...
- [Private Link Services](https://learn.microsoft.com/en-us/azure/private-link/private-link-service-overview)
...
- [Azure Backup Monitoring and Reporting Solutions](https://learn.microsoft.com/en-us/azure/backup/monitoring-and-alerts-overview)
- [Configure Azure Backup Reports](https://learn.microsoft.com/en-us/azure/backup/configure-reports)
- [Configure Azure Backup Alert Notifications](https://learn.microsoft.com/en-us/azure/backup/backup-azure-monitor-alerts-notification)
...
Microsoft Learn offers comprehensive learning paths for AZ-104:

- [Prerequisites for Azure Administrator](https://learn.microsoft.com/en-us/training/paths/az-900-azure-fundamentals/)
- [Manage Azure Identities and Governance](https://learn.microsoft.com/en-us/training/paths/manage-azure-identities-governance/)
- [Implement and Manage Storage](https://learn.microsoft.com/en-us/training/paths/implement-manage-storage-in-azure/)
- [Deploy and Manage Azure Compute Resources](https://learn.microsoft.com/en-us/training/paths/deploy-manage-azure-compute-resources/)
- [Implement and Manage Virtual Networking](https://learn.microsoft.com/en-us/training/paths/implement-manage-virtual-networking-azure/)
- [Monitor and Maintain Azure Resources](https://learn.microsoft.com/en-us/training/paths/monitor-maintain-azure-resources/)
